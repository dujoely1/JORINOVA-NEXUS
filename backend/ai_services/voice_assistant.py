...
NAVIGATION_MAP = {
    # English commands
    # NOTE: targets are the live Next.js app routes (/modules/*). The legacy
    # backend HTML routes (/patients/, /hematology/, …) were removed when the
    # UI migrated to Next.js, so they 404 — keep these in sync with the
    # frontend KEYWORDS map in frontend/app/components/VoiceMic.tsx.
    'dashboard':        ('/dashboard', 'Opening the main dashboard.'),
    'home':             ('/dashboard', 'Going to dashboard.'),
    'reception':        ('/modules/lis_mapping', 'Opening sample reception.'),
    'worklist':         ('/modules/laboratory',  'Opening worklist preparation.'),
    'hematology':       ('/modules/hematology','Opening hematology department.'),
    'haematology':      ('/modules/hematology','Opening haematology department.'),
    'biochemistry':     ('/modules/biochemistry','Opening biochemistry.'),
    'chemistry':        ('/modules/biochemistry','Opening chemistry department.'),
    'microbiology':     ('/modules/microbiology','Opening microbiology.'),
    'micro':            ('/modules/microbiology','Opening microbiology.'),
    'molecular':        ('/modules/molecular_advanced','Opening molecular diagnostics.'),
    'urinalysis':       ('/modules/laboratory','Opening urinalysis department.'),
    'urine':            ('/modules/laboratory','Opening urinalysis.'),
    'coagulation':      ('/modules/coagulation','Opening coagulation department.'),
    'blood bank':       ('/modules/blood_bank','Opening blood bank.'),
    'transfusion':      ('/modules/blood_bank','Opening blood bank and transfusion.'),
    'serology':         ('/modules/serology','Opening serology and immunology.'),
    'immunology':       ('/modules/serology','Opening immunology department.'),
    'pathology':        ('/modules/anapath','Opening pathology department.'),
    'toxicology':       ('/modules/toxicology','Opening toxicology department.'),
    'quality':          ('/modules/quality','Opening quality management.'),
    'quality control':  ('/modules/quality','Opening quality control.'),
    'levey jennings':   ('/modules/quality','Opening Levey-Jennings QC chart.'),
    'levey-jennings':   ('/modules/quality','Opening Levey-Jennings chart.'),
    'records':          ('/modules/register','Opening laboratory records.'),
    'patients':         ('/modules/patients','Opening patient registry.'),
    'patients hub':     ('/modules/patients','Opening patients hub.'),
    'surveillance':     ('/modules/surveillance','Opening epidemic surveillance.'),
    'inventory':        ('/modules/inventory','Opening inventory management.'),
    'billing':          ('/modules/billing','Opening billing system.'),
    'reports':          ('/modules/register','Opening reports module.'),
    'audit':            ('/modules/audit','Opening audit trail.'),
    'staffhub':         ('/modules/staffhub','Opening staff hub.'),
    'staff':            ('/modules/staffhub','Opening staff management.'),
    'admin':            ('/admin','Opening administration panel.'),
    'settings':         ('/modules/settings','Opening system settings.'),
    'genomics':         ('/modules/molecular_advanced','Opening genomics module.'),
    'ai':               ('/modules/ai_nexus','Opening A I intelligence hub.'),
    'microbiology ai':  ('/modules/ai_nexus','Opening microbiology AI module.'),
    'security':         ('/admin','Opening security module.'),
    'interoperability': ('/modules/connectivity','Opening interoperability module.'),
    'notifications':    ('/modules/notifications','Opening notifications.'),
    # French commands
    'accueil':          ('/dashboard','Ouverture du tableau de bord.'),
    'réception':        ('/modules/lis_mapping','Ouverture de la réception des échantillons.'),
    'hématologie':      ('/modules/hematology','Ouverture du département d\'hématologie.'),
    'biochimie':        ('/modules/biochemistry','Ouverture de la biochimie.'),
    'microbiologie':    ('/modules/microbiology','Ouverture de la microbiologie.'),
    'moléculaire':      ('/modules/molecular_advanced','Ouverture de la biologie moléculaire.'),
    'banque du sang':   ('/modules/blood_bank','Ouverture de la banque du sang.'),
    'qualité':          ('/modules/quality','Ouverture du contrôle qualité.'),
    'patients':         ('/modules/patients','Ouverture du registre des patients.'),
    'facturation':      ('/modules/billing','Ouverture de la facturation.'),
    'dossiers':         ('/modules/register','Ouverture des dossiers de laboratoire.'),
    # Kinyarwanda commands
    'amagara':          ('/modules/hematology','Fungura igice cy\'amaraso.'),
    'inkingo':          ('/modules/blood_bank','Fungura banki y\'amaraso.'),
